...
plot(data$Date_Time,data$Global_active_power,type = "l",col="black",xlab="",ylab="Global Active Power",fg="black")
...
plot(data$Date_Time,data$Voltage,type = "l",col="black",xlab="Date and Time",ylab="Voltage",fg="black")

plot(data$Date_Time,data$Global_reactive_power,type = "l",col="black",xlab="Date and Time",ylab="Global Reactive Power",fg="black")
